...
const (
	...
	// ServiceUsageKey is the configuration key for retrieving the usage information
	ServiceUsageKey = "service.usage"
	// ServiceUsageKey is the configuration key for retrieving the short description of the application
	ServiceShortDescriptionKey = "service.short"
	// ServiceUsageKey is the configuration key for retrieving the long description of the application
	ServiceLongDescriptionKey = "service.long"
